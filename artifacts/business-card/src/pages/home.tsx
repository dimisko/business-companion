...
// Hardcoded Data & Assets Strategy
const PROFILE_DATA = {
  name: "Dime Mishkov",
  ...
  imagePath: `${import.meta.env.BASE_URL}profile.jpg`, // Requires profile.jpg in public/
  cvPath: `${import.meta.env.BASE_URL}Dime-Mishkov-CV.pdf`, // Requires Dime-Mishkov-CV.pdf in public/
          ...
          >
            <div className="relative group">
              ...
              <Avatar className="w-32 h-32 border-[6px] border-background bg-card shadow-2xl relative z-10 transition-transform duration-500 hover:scale-[1.02]">
                <AvatarImage src={PROFILE_DATA.imagePath} alt={PROFILE_DATA.name} className="object-cover" />
                <AvatarFallback className="text-3xl font-display font-bold text-primary bg-secondary">
                  DM
                </AvatarFallback>
              </Avatar>
            </div>
          ...
          <CardContent className="pt-20 pb-8 px-6 sm:px-8 flex flex-col items-center text-center">
              ...
              {ACTIONS.map((action, i) => (
                <motion.div key={i} variants={itemVariants} className="w-full">
                  <Button
                    ...
                    className={`
                      w-full h-14 rounded-2xl text-[15px] font-semibold group transition-all duration-300 hover-elevate active-elevate
                      ${action.primary 
            ...
            >
              <div className="flex items-center justify-center gap-6">
                ...
                <motion.div variants={itemVariants} className="w-1 h-1 rounded-full bg-white/10" />
